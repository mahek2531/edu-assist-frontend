...
const CompleteProfilePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-indigo-800 to-blue-700 flex items-center justify-center px-4 py-10 ea-onboarding-shell ea-auth-stage">
      <AuthPortalScene variant={isJunior ? 'junior' : 'senior'} />
      <div className="w-full max-w-lg bg-white rounded-3xl shadow-2xl p-8 ea-command-panel ea-auth-card ea-profile-terminal">
        <div className="text-center mb-8">
          ...
          <div className="mt-5 ea-level-bar" aria-label="Profile completion progress">
            <span style={{ width: `${rollNumber.trim() && (photo || preview) ? 100 : rollNumber.trim() || photo || preview ? 62 : 28}%` }} />
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          {preview && (
            <div className="flex items-center gap-4 bg-gray-50 rounded-2xl border border-gray-200 p-4">
              <img
                src={preview}
                alt="Profile preview"
              ...
              />
              <div>
                <p className="font-semibold text-gray-900">Photo Preview</p>
                <p className="text-sm text-gray-500">This photo will appear on your dashboard.</p>
              </div>
            </div>
          )}
